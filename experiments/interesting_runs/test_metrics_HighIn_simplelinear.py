...
#
# # test all policies
# used_seeds, results_rl, test_actions = tester100.test_rl_model_nobatch(rl_module=rl_mod)
# used_seeds, results_rl, test_actions = tester100.test_rl_model_nobatch(rl_module=rl_mod)
#
...
#
# #test_seeds, test_results_rl = tester100.test_action_replay_2(test_actions)
#
...
# # rl results
# test_rl_Nfsco = test_results_rl["no_cor_both_finishes"]
# test_rl_Ntot = test_results_rl["no_total_finishes"]
# test_rl_Nco = test_results_rl["no_cor_order_finishes"]
# test_rl_Nfs = test_results_rl["no_cor_plan_finishes"]
# test_rl_reward = test_results_rl["rewards"]
# # calculate other values
# test_rl_Nnfsco = test_rl_Nco - test_rl_Nfsco
# test_rl_Nfswo = test_rl_Nfs - test_rl_Nfsco
# test_rl_Nnfswo = test_rl_Ntot - test_rl_Nfswo - test_rl_Nnfsco - test_rl_Nfsco
# test_rl_Nnfs = test_rl_Ntot - test_rl_Nfs
# test_rl_Nwo = test_rl_Ntot - test_rl_Nco
# arrays = [test_rl_Nfsco, test_rl_Nfswo, test_rl_Nnfsco, test_rl_Nnfswo, test_rl_Ntot, test_rl_Nco, test_rl_Nfs, test_rl_Nwo, test_rl_Nnfs]
# labels = [r"N_{FS, CO}", r"N_{FS, WO}", r"N_{NFS, CO}", r"N_{NFS, WO}", r"N_{out}", r"N_{CO}", r"N_{FS}", r"N_{WO}", r"N_{NFS}"]
# #fig = plot_arrays(arrays, labels, save_path, title="rl_module_counts_" + num_seeds)
# #plt.show
...
# print("test: Metrics for RL-PPO:")
# print(f"Ntot: {test_rl_Ntot.mean():.2f} ± {test_rl_Ntot.std():.2f}")
# print(f"Nfsco: {test_rl_Nfsco.mean():.2f} ± {test_rl_Nfsco.std():.2f}")
# print(f"percentage Nfsco: {test_rl_Nfsco.mean() / test_rl_Ntot.mean() * 100:.2f}")
# print(f"Nnfsco: {test_rl_Nnfsco.mean():.2f} ± {test_rl_Nnfsco.std():.2f}")
# print(f"Nfswo: {test_rl_Nfswo.mean():.2f} ± {test_rl_Nfswo.std():.2f}")
# print(f"Nnfswo: {test_rl_Nnfswo.mean():.2f} ± {test_rl_Nnfswo.std():.2f}")
# print(f"Nnfs: {test_rl_Nnfs.mean():.2f} ± {test_rl_Nnfs.std():.2f}")
# print(f"percentage Nnfs : {test_rl_Nnfs.mean() / test_rl_Ntot.mean() * 100:.2f}")
# print(f"Nwo: {test_rl_Nwo.mean():.2f} ± {test_rl_Nwo.std():.2f}")
# print(f"percentage Nwo: {test_rl_Nwo.mean() / test_rl_Ntot.mean() * 100:.2f}")
# print(f"Ntot-Nfsco: {(test_rl_Ntot - test_rl_Nfsco).mean():.2f} ± {(test_rl_Ntot - test_rl_Nfsco).std():.2f}")
# print(f"percent violations: {(test_rl_Ntot - test_rl_Nfsco).mean() / test_rl_Ntot.mean() * 100:.2f}")
