...
# model_folder_name_low = r"PLATEAU2_simple_3by3_oldarrival_run_arrival_change_201_007_simple_linear_t_2025-06-17_13-11-15"
model_folder_name_low = r"PLATEAU2_simple_3by3_oldarrival_simple_linear"

model_folder_name_high = r"PLATEAU1_simple_3by3_oldarrival_run_arrival_change_201_007_simple_linear_t_2025-06-17_12-29-08"
model_folder_name_high = r"PLATEAU1_simple_3by3_oldarrival_simple_linear"
...
df_titles_least_good = [r"\textrm{Training}", r"\textrm{Validation}"]
...
all_train_rewards = [df_train_reward_good, df_train_reward_low, df_train_reward_high]
all_labels = [r"Low~and~high~beta", "Low~beta", r"High~beta"]

plot_dfs(
    df_counts=all_train_rewards,
    df_titles=all_labels,
    save_path=csv_path_general_good,
    title="reward_comparison_plateaus",
    beta_step=90,
    beta_label="",
    y_label="Mean reward",
)
...
all_labels_relevant = [
    r"Low~and~high~beta~~\overline{N}_{out}",
    r"Low~and~high~beta~~\overline{N}_{FS, CO}",
    r"Low~beta~~\overline{N}_{out}",
    r"Low~beta~~\overline{N}_{FS, CO}",
    r"High~beta~~\overline{N}_{out}",
    r"High~beta~~\overline{N}_{FS, CO}",
]
plot_dfs_dotted(
    df_counts=all_val_metrics_relevant,
    df_titles=all_labels_relevant,
    save_path=csv_path_general_good,
    title="val_metrics_comparison_plateaus",
    beta_step=90,
    beta_label=r"",
)
